...
export default [
    Page("General", icons.ui.settings,
        ...
        Group("Weather",
            Row({ opt: w.unit, title: "Unit", type: "enum", enums: ["metric", "imperial", "standard"] }),
            Row({ opt: w.latitude, title: "Latitude", type: "float" }),
            Row({ opt: w.longitude, title: "Longitude", type: "float" }),
            Row({ opt: w.key, title: "API Key" }),
            Row({ opt: w.interval, title: "API Call Interval", type: "float" }),
        ),
    ),
    Page("Bar", icons.ui.toolbars,
        Group("General",
            Row({ opt: b.flatButtons, title: "Flat Buttons" }),
            Row({ opt: b.floating, title: "Floating" }),
    ...
    Page("Theme", icons.ui.themes,
        Group("",
            ...
            Row({ opt: primary, title: "Primary", type: "enum", enums: ["red", "green", "yellow", "blue", "purple", "teal", "orange"] }),
        ),
        Group("Theme",
